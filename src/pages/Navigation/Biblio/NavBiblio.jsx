...
function NavBiblio(props) {
    ...
    const toggleMinimiserBiblio = () => {
        dispatch(biblioActions.toggleMinimiser());
    };

    const toggleExpandedBiblio = () => {
        dispatch(biblioActions.toggleExpanded());
    };

    const toggleModeBiblio = () => {
        dispatch(biblioActions.toggleMode());
    };
    ...
    return (
        <>
            <div className={styles['container-buttons']}>
                ...
                {viewBiblio.expandedBiblio && (
                    <button
                        onClick={toggleModeBiblio}
                        className={[
                            styles['biblio-button'],
                            styles['biblio-mode'],
                        ].join(' ')}
                    >
                        {viewBiblio.mode === 'grille' && (
                            <svg
                                role="img"
                                height="16"
                                width="16"
